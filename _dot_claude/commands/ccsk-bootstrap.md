---
name: ccsk-bootstrap
description: Bootstrap a project with ccsk — interview the user, then write technical-stacks, architecture, docs, CLAUDE.md role, and a phased implementation plan. Works for empty or existing projects.
...
> Canonical name: `ccsk-bootstrap`. Lives at `.claude/commands/ccsk-bootstrap.md`.
